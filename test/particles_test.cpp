...
TEST(ParticlesTest, Constructor)
{
	...
	Particles<double, Eigen::Vector3d> particles_13d_test(1.0, 1.0);
	EXPECT_EQ (0, particles_13d_test.getNumParticles());

	Particles<Eigen::Vector2d, Eigen::Vector2d>
		particles_22d_test(1.0, 1.0);
	EXPECT_EQ (0, particles_22d_test.getNumParticles());

	Particles<Eigen::Vector2d, Eigen::Vector3d>
		particles_23d_test(1.0, 1.0);
	EXPECT_EQ (0, particles_23d_test.getNumParticles());
